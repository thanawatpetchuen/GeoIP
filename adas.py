...
class LogParse:
    def __init__(self):
        ...
        self.l = []
        self.country = []
        self.api = "https://ip-api.com/json/{}"
        self.latfor = 'latitude'
        self.lonfor = 'longitude'
        self.countfor = 'country_name'

        # App config
        self.app = gui("Log Analyzer", "500x800")
        fileMenus = ["Save Figure..."]
        self.app.addMenuList("File", fileMenus, self.save)
        self.app.addMenuCheckBox("Setting", "ip-api.com", self.setting)
        self.app.addMenuCheckBox("Setting", "ipapi.co", self.setting2)
        self.app.addMenuCheckBox("Setting", "ip-api.io", self.setting3)
        ...
        self.setting()
        self.app.setMenuCheckBox("Setting", "ip-api.com", True)
        # Basemap
    ...
    def setting(self, btn=None):
        # print("yes from setting")
        self.app.setMenuCheckBox("Setting", 'ipapi.co', False)
        self.app.setMenuCheckBox("Setting", 'ip-api.io', False)
        self.api = 'http://ip-api.com/json/{}'
        self.latfor = 'lat'
        self.lonfor = 'lon'
        self.countfor = 'country'
        print(self.api, self.latfor, self.lonfor, self.countfor)

    def setting2(self, btn=None):
        self.app.setMenuCheckBox("Setting", 'ip-api.com', False)
        self.app.setMenuCheckBox("Setting", 'ip-api.io', False)
    ...
    def setting3(self, btn=None):
        self.app.setMenuCheckBox("Setting", 'ipapi.co', False)
        self.app.setMenuCheckBox("Setting", 'ip-api.com', False)
        self.api = "https://ip-api.io/json/{}"
        self.latfor = 'latitude'
        self.lonfor = 'longitude'
        self.countfor = "country_name"
        print(self.api, self.latfor, self.lonfor, self.countfor)
